...
> CLASS A KHAI BÁO BIẾN OBJECT CỦA CLASS B VÀ NEW LUÔN B() TRONG CLASS A
> - A KIỂM SOÁT OBJECT B, ĐC GỌI LÀ TIGHT COUPLING, FULL CONTROL OBJECT B, HARD CODE DEPENDENCY 
> - TRONG LÒNG A, CODE A CÓ CỨNG SẴN OBJECT B 
